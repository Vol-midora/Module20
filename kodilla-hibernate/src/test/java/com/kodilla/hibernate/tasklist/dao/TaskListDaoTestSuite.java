...
public class TaskListDaoTestSuite {
    ...
    private static final String NAME = "Test TaskList name";
    ...
    public void testTaskListDaoFindByListName() {
        ...
        //Then
        TaskList readList = taskListDao.findByListName(NAME).get(0);
        Assert.assertEquals(DESCRIPTION, readList.getDescription());
