package com.kodilla.spring.patterns;
...
import com.kodilla.spring.patterns.facade.api.ItemDto;
import com.kodilla.spring.patterns.facade.api.*;
import com.kodilla.spring.patterns.facade.api.OrderFacade;
...
//    }
    ...
    public void testOrderFacade() {
    	...
    	try {
    		...
    		//business exception - should be handled properly
    	}
    }
